...
module sanguinololu_top(width=80,length=40){
	difference(){
		...
		translate([46,-20,15])rotate([0,0,90])holes(diameter=4,rows=4,cols=8);		
...
/*	translate([47,22,-21])nut(d=m4_nut_diameter_horizontal,h=2.5);
		...
		translate([-47,-22,-21])nut(d=m4_nut_diameter_horizontal,h=2.5);
*/	
		translate([0,26,-12])cube([80, 6, 12],center = true);
		translate([-52,-12.1,-10.1])cube([4, 20, 12],center = true);
	};
	rotate([0,0,-180])translate([-66,-28,-20])support();
	mirror()rotate([0,0,-180])translate([-66,-28,-20])support();
}
...
module sanguinololu(){
	difference(){
		...
		translate([47,22,-3])cylinder(r=3,h=36);
		translate([-47,-22,-3])cylinder(r=3,h=36);
		translate([-47,22,-3])cylinder(r=3,h=36);
		translate([47,-22,-3])cylinder(r=3,h=36);
...
module support(){
	...
	difference(){
		...
		translate([6,7.5,7])rotate([90,0,0])screw_cylinder();
	}
